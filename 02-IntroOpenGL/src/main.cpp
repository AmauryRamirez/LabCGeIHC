...
void init(int width, int height, std::string strTitle, bool bFullScreen) {
	...
	Vertex vertices[] = {
		{{0.0, 0.0, 0.0}, {0.2, 0.3, 0.5}}, //P0 Posición, Color
		{{0.2, 0.7, 0.0}, {0.2, 0.5, 0.3}}, //P3
		{{0.0, 0.7, 0.0}, {0.2, 0.4, 0.1}},	//P2
		{{0.0, 0.7, 0.0}, {0.2, 0.1, 0.6}}, //P2
		{{0.2, 0.7, 0.0}, {1.0, 0.2, 0.12}}, //P3
		{{0.0, 0.85, 0.0}, {0.4, 0.1, 0.8}}, //P4 FIN DE PRIMER TRIANGULO
		{{0.0, 0.0, 0.0}, {0.2, 0.3, 0.5}},	//P0
		{{0.2, 0.7, 0.0}, {1.0, 0.2, 0.12}}, //P3
		{{-0.2, 0.7, 0.0}, {0.3, 0.3, 0.4}}, //P1
		{{-0.2, 0.7, 0.0}, {0.3, 0.3, 0.4}}, //P1
		{{0.2, 0.7, 0.0}, {1.0, 0.2, 0.12}}, //P3
		{{0.0, 0.85, 0.0}, {0.4, 0.1, 0.8}}, //P4 FIN DE PRIMER TRIANGULO
		{{0.0, 0.0, 0.0}, {0.2, 0.3, 0.5}}, //P0
		{{-0.7, 0.2, 0.0}, {0.2, 0.4, 0.0}}, //P10
		{{-0.7, 0.0, 0.0}, {0.2, 0.4, 0.0}}, //P11
		{ {0.0, 0.0, 0.0}, {0.2, 0.3, 0.5}}, //P0
		{{-0.7, 0.0, 0.0}, {0.2, 0.4, 0.0}}, //P11
		{ {-0.7, -0.2, 0.0}, {0.2, 0.4, 0.0}}, //P9
		{ {-0.7, 0.2, 0.0}, {0.2, 0.4, 0.0}}, //P10
		{{-0.7, 0.0, 0.0}, {0.2, 0.4, 0.0}}, //P11
		{ {-0.85, 0.0, 0.0}, {0.2, 0.4, 0.0}}, //P12
		{ {-0.85, 0.0, 0.0}, {0.2, 0.4, 0.0}}, //P12
		{ {-0.7, 0.2, 0.0}, {0.2, 0.4, 0.0}}, //P10
		{{-0.7, 0.0, 0.0}, {0.2, 0.4, 0.0}} //P11
