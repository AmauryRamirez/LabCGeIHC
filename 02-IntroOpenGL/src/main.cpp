...
void init(int width, int height, std::string strTitle, bool bFullScreen) {
	...
	*/
	...
	Vertex vertices[] ={
		...
		//FACHADA FONDO
		{{0.25, 0.2, 0.0}, {2.0, 2.0, 0.0}}, {{0.25, -0.2, 0.0}, {2.0, 2.0, 0.0}},{{-0.25, -0.2, 0.0}, {2.0, 2.0, 0.0}},{{-0.25, -0.2, 0.0}, {2.0, 2.0, 0.0}},{{0.25, 0.2, 0.0}, {2.0, 2.0, 0.0}},{{-0.25, 0.2, 0.0}, {2.0, 2.0, 0.0}},
		//TRIANGULO BASE 
		{{-0.25, 0.2, 0.0}, {2.0, 2.0, 0.0}}, {{0.25, 0.2, 0.0}, {2.0, 2.0, 0.0}},{{0.0, 0.42, 0.0}, {2.0, 2.0, 0.0}},//-------------------
